...
// 递归先序遍历
void PreOrderVisit(BiTree t, function<void(BiTree)> visit) {
    if (!t) return;
    visit(t);
...
// 递归中序遍历
void InOrderVisit(BiTree t, function<void(BiTree)> visit) {
    if (!t) return;
...
// 递归后序遍历
void PostOrderVisit(BiTree t, function<void(BiTree)> visit) {
    if (!t) return;
...
// 非递归先序遍历
void PreOrderVisit2(BiTree t, function<void(BiTree)> visit) {
    stack<BiTree> s;
    while (t || !s.empty()) {
        if (t) {
            visit(t);       // 先访问当前子树的根结点
...
// 非递归中序遍历
void InOrderVisit2(BiTree t, function<void(BiTree)> visit) {
    stack<BiTree> s;
    while (t || !s.empty()) {
        if (t) {
...
// 非递归后序遍历
void PostOrderVisit2(BiTree t, function<void(BiTree)> visit) {
    stack<BiTree> s;
...
// 层次遍历
void LevelOrderVisit(BiTree t, function<void(BiTree)> visit) {
    if (!t) {
        return;  // 空树直接返回
    }
    queue<BiTree> q;
